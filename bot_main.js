...
const command_forcesay = new newBotCommand('forcesay', FALSE, 'Forcesay', 'HIDDEN', COMMAND_PERMISSION_OWNER);
...
const command_restart = new newBotCommand('restart', FALSE, 'Requires bot start wrapper. Restarts the bot.', 'Misc', COMMAND_PERMISSION_OPERATOR);
...
const command_ratewaifu = new newBotCommand('ratewaifu', TRUE, 'Rates someone in the channel as your waifu.', 'Fun', COMMAND_PERMISSION_PUBLIC);
...
const command_reset_persistence = new newBotCommand('reset_persistence', TRUE, 'Resets persistent non-config variables.', 'Misc', COMMAND_PERMISSION_OPERATOR);
//PERSISTENCE RESET
...
const command_ship = new newBotCommand('ship', FALSE, 'Creates a random pairing!', 'Fun', COMMAND_PERMISSION_PUBLIC);
...
const command_rig1 = new newBotCommand('rig_one', FALSE, '', 'HIDDEN', COMMAND_PERMISSION_OPERATOR);
...
const command_rig2 = new newBotCommand('rig_two', FALSE, '', 'HIDDEN', COMMAND_PERMISSION_OPERATOR);
...
const command_script = newBotCommand('script', FALSE, '', 'HIDDEN', COMMAND_PERMISSION_OWNER);
...
const command_debug_var = newBotCommand('debugvar', FALSE, '', 'HIDDEN', COMMAND_PERMISSION_OWNER);
